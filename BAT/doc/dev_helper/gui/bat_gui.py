...
#    Apr 14, 2020 10:09:32 PM CEST  platform: Linux
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Radiobutton_Jt_min.configure(variable=bat_gui_support.selectedButton)
        ...
        self.Radiobutton_Jt_mean.configure(variable=bat_gui_support.selectedButton)
        ...
        self.Entry_Cof_Head_Min.configure(cursor="fleur")
        ...
        self.TLabel1_11 = ttk.Label(self.Labelframe_Bolt_Def)
        self.TLabel1_11.place(relx=0.015, rely=0.91, height=26, width=277
                , bordermode='ignore')
        self.TLabel1_11.configure(background="#d9d9d9")
        self.TLabel1_11.configure(foreground="#000000")
        self.TLabel1_11.configure(font="TkDefaultFont")
        ...
        self.TLabel1_11.configure(anchor='e')
        self.TLabel1_11.configure(justify='left')
        self.TLabel1_11.configure(text='''Torque Tolerance of Tightening Device:''')
        ...
        self.Radiobutton_Lock_No.configure(variable=bat_gui_support.selectedButton)

        self.Radiobutton_Lock_Yes = tk.Radiobutton(self.Labelframe_Bolt_Def)
        self.Radiobutton_Lock_Yes.place(relx=0.561, rely=0.835, relheight=0.058
                , relwidth=0.103, bordermode='ignore')
        ...
        self.Radiobutton_Lock_Yes.configure(variable=bat_gui_support.selectedButton)
        ...
        self.TLabel2_13.configure(anchor='center')
        self.TLabel2_13.configure(justify='left')
        self.TLabel2_13.configure(text='''Tp:''')
        ...
        self.Radiobutton_Esapss.configure(variable=bat_gui_support.selectedButton)

        self.Radiobutton_VDI2230 = tk.Radiobutton(self.TNotebook_Joint_Input)
        self.Radiobutton_VDI2230.place(relx=0.643, rely=0.041, relheight=0.051
                , relwidth=0.2)
        self.Radiobutton_VDI2230.configure(justify='left')
        self.Radiobutton_VDI2230.configure(text='''VDI 2230''')
        self.Radiobutton_VDI2230.configure(variable=bat_gui_support.selectedButton)
        ...
        self.Radiobutton_ECSS.configure(variable=bat_gui_support.selectedButton)
